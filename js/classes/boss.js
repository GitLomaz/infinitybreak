      ...
      switch (animation.key) {
        ...
        case "boss_idle_single_swipe":
          if (Phaser.Math.Between(1, 4) === 1) {
            ...
            Phaser.Math.Between(1, 2) === 1 ? this.swipeUp() : this.swipeDown();
          }
          break;
  ...
  swipeUp() {
    ...
    if (that.health > 0) {
      ...
      setTimeout(function () {
        if (that.health > 0) {
          that.setFrame(17);
          scene.gameVars.enemyBullets.fireBullet(that.x, that.y - 50, 6, 10);
          scene.gameVars.enemyBullets.fireBullet(that.x, that.y - 50, 6, 15);
          setTimeout(function () {
            if (that.health > 0) {
              that.setFrame(18);
